            ...
            <div class="mb-6 border border-border rounded-lg p-4">
              ...
              <div class="space-y-4">
                <article v-for="item in order.items" class="flex justify-between items-center">
                  <div class="flex items-start gap-4">
                    <img :src="item.course?.cover_url" :alt="item.course?.title" class="h-20 w-auto">
                    <div class="flex-grow">
          ...
          <div v-if="order.user" class="flex-none w-72 space-y-4">
            ...
            <div v-if="order.payment" class="border border-border rounded-lg p-4">
              <div class="flex items-center justify-between py-4">
                ...
                <span class="bg-success text-white px-2 rounded-full text-sm capitalize">{{ order.payment?.status
                }}</span>
              </div>
            ...
            <div v-if="order.referral" class="border border-border rounded-lg p-4">
              ...
              <div class="space-y-2">
                ...
                <div class="flex items-center justify-between">
                  ...
                  <span v-else class="bg-danger text-white px-2 py-0.5 rounded-full text-sm">{{ order.referral?.status
                  }}</span>
                </div>
              </div>
            </div>
