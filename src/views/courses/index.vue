        ...
        <div class="card__body">
          <template v-if="courses && courses.data">
                  ...
                  <tr v-for="course in courses.data">
                    ...
                    <td>
                      <div class="flex items-center gap-2">
                        ...
                        <del
                          v-if="course.base_price && course.base_price > course.price"
                          class="text-gray-400"
                        >
                    ...
                    <td class="text-right">
                      <div class="flex items-center gap-2 text-gray-500">
                        <RouterLink
                          :to="{ name: 'course.basic', params: { id: course.id } }"
            ...
            <Pagination
              ...
              :current-page="courses.meta.current_page"
              :items-per-page="courses.meta.per_page"
              :pages-to-show="2"
              @page-change="getCourses"
              visible-always
            />
          </template>
